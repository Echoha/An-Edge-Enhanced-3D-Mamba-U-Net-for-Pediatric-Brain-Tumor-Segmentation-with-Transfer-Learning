...
class PolyLRScheduler(_LRScheduler):
    ...
    def state_dict(self):
        ...
        state_dict = {
            ...
            'ctr': self.ctr,  # 保存当前步数
            'last_epoch': self.last_epoch  # 从 _LRScheduler 继承的
        }
        return state_dict
    ...
    def load_state_dict(self, state_dict):
        ...
        self.exponent = state_dict['exponent']
        self.ctr = state_dict['ctr']  # 恢复当前步数
        self.last_epoch = state_dict['last_epoch']  # 恢复 _LRScheduler 的 last_epoch
